...
class CobrarController extends Controller
{
    ...
    public function index()
    {
        ...
        $cobrar = DB::table('atenciones as a')
        ->select('a.id','a.tipo_origen','a.id_origen','a.usuario','a.created_at','a.estatus','a.id_paciente','a.tipo_atencion','a.monto','a.abono','a.tipo_pago','b.nombres','b.apellidos','c.name as nameo','c.lastname as lasto','d.name as nameu','d.lastname as lastu')
        ->join('pacientes as b','b.id','a.id_paciente')
        ->join('users as c','c.id','a.id_origen')
        ->join('users as d','d.id','a.usuario')
        ->where('a.monto', '>', 'a.abono')
        //->where('a.monto', '!=', '0')
        ->get(); 


        return view('cuentascobrar.index', compact('cobrar'));
        //
    }
